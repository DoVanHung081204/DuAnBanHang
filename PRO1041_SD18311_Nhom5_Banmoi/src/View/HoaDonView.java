    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        if (selectedSanPhamRow >= 0) {
            ...
            if (!maHoaDon.isEmpty()) {
                ...
                if (!existed) {
                    // Get the variant ID from tblSanPham and append it after the product ID in tblHoaDonChiTiet
                    ...
                    tblSanPham.setValueAt(soLuongTon - soLuong, selectedSanPhamRow, columnSoLuongTonIndex);
                } else {
                    ...
                    // Giảm số lượng sản phẩm bên tblSanPham
                    tblSanPham.setValueAt(soLuongTon - (currentQuantity + 1), selectedSanPhamRow, columnSoLuongTonIndex);
                }
